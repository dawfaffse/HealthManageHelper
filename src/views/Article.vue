 ...
 <div class="articleDetail-container">
    ...
    <div class="content">
      ...
      <div class="diary-card">
        <div class="back-knowledge-list">
        <el-icon @click="handleBackKnowledgeList"><back/></el-icon>
        ...
        <h1 class="artice-title" style="margin-top: 20px;"> {{ articleDetail.title }}</h1>
...
const handleBackKnowledgeList = () => {
  router.push('/knowledge')
}

onMounted(() => {
    getKnowledgeArticleDetail(route.params.id).then(res => {
      console.log(res)

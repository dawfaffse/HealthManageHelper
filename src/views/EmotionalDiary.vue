    ...
    <div class="content">
      <div class="diary-card">
        ...
        <div class="section">
          ...
          <div class="rate">
            <el-rate v-model="formData.moodScore" :texts="emotionStatus"  show-texts :max="10" :size="24" />
          </div>
        </div>
      </div>
      <div class="diary-card">
        ...
        <div class="emotion-grid">
          <div v-for="emotion in emotionOptions" :key="emotion.name" class="emotion-card" :class="{'selected': formData.dominantEmotion === emotion.name}" @click="selsctEmotion(emotion.name)">
       ...
       <div class="diary-card">
        ...
        <div class="detail-form">
          ...
          <el-input v-model="formData.emotionTriggers" placeholder="今天什么事情影响了您的情绪?" type="textarea" :rows="3" maxlength="1000" show-word-limit clearable></el-input>
        </div>
         ...
         <div class="form-group">
          ...
          <el-input v-model="formData.diaryContent" placeholder="写下您今天的想法，感受发生的有趣事情..." type="textarea" :rows="4" maxlength="2000" show-word-limit clearable></el-input>
        ...
        <div class="life-indicators">
          <div class="indicator-group">
           ...
           <el-select v-model="formData.sleepQuality" placeholder="请选择睡眠质量" clearable>
          ...
          <div class="indicator-group">
           ...
           <el-select v-model="formData.stressLevel" placeholder="请选择压力等级" clearable>
...
const submitForm = () => {
  ...
  if(!formData.value.moodScore) {
    ElMessage.error('请选择情绪评分')
    return
  }
  submitEmotionDiary (formData.value).then(()=>
{
...
const selsctEmotion = (emotion) => {
  formData.value.dominantEmotion = emotion
